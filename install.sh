...
usage() {
  this=$1
  cat <<EOF
$this: download pre-compiled Docker images for unelmacoin/rosetta-unelmacoin 
Usage: $this [-d]
...
execute() {
  ...
  docker tag "rosetta-unelmacoin:${TAG}" "rosetta-unelmacoin:latest"
  log_info "loaded rosetta-unelmacoin:${TAG} and tagged as rosetta-unelmacoin:latest"
  rm -rf "${tmpdir}"
