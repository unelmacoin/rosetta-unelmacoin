...
import (
	...
	unelmacoin "github.com/unelmacoin/rosetta-unelmacoin/unelmacoin"
...
func (_m *Client) GetRawBlock(_a0 context.Context, _a1 *types.PartialBlockIdentifier) (*unelmacoin.Block, []string, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *unelmacoin.Block
	if rf, ok := ret.Get(0).(func(context.Context, *types.PartialBlockIdentifier) *unelmacoin.Block); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*unelmacoin.Block)
		}
	}
...
func (_m *Client) ParseBlock(_a0 context.Context, _a1 *unelmacoin.Block, _a2 map[string]*types.AccountCoin) (*types.Block, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 *types.Block
	if rf, ok := ret.Get(0).(func(context.Context, *unelmacoin.Block, map[string]*types.AccountCoin) *types.Block); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *unelmacoin.Block, map[string]*types.AccountCoin) error); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		r1 = ret.Error(1)
	}
