...
func (_m *Indexer) GetScriptPubKeys(_a0 context.Context, _a1 []*types.Coin) ([]*unelmacoin.ScriptPubKey, error) {
	ret := _m.Called(_a0, _a1)

	var r0 []*unelmacoin.ScriptPubKey
	if rf, ok := ret.Get(0).(func(context.Context, []*types.Coin) []*unelmacoin.ScriptPubKey); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*unelmacoin.ScriptPubKey)
		}
	}
