...
const (
	...
	// of rosetta-unelmacoin. We set this as a
...
type unsignedTransaction struct {
	...
	ScriptPubKeys  []*unelmacoin.ScriptPubKey `json:"scriptPubKeys"`
...
type constructionMetadata struct {
	ScriptPubKeys []*unelmacoin.ScriptPubKey `json:"script_pub_keys"`
}
...
type ParseOperationMetadata struct {
	ScriptPubKey *unelmacoin.ScriptPubKey `json:"scriptPubKey"`
}
