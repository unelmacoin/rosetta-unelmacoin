...
import (
	...
	unelmacoinUtils "github.com/unelmacoin/rosetta-unelmacoin/utils"
...
const (
	...
	// genesis block of the unelmacoin blockchain for polling
	genesisBlockIndex = 0
...
const (
	// https://unelmacoin.org/en/developer-reference#getblock
	requestMethodGetBlock requestMethod = "getblock"

	// https://unelmacoin.org/en/developer-reference#getblockhash
	requestMethodGetBlockHash requestMethod = "getblockhash"

	// https://unelmacoin.org/en/developer-reference#getblockchaininfo
	requestMethodGetBlockchainInfo requestMethod = "getblockchaininfo"

	// https://developer.unelmacoin.org/reference/rpc/getpeerinfo.html
	requestMethodGetPeerInfo requestMethod = "getpeerinfo"

	// https://developer.unelmacoin.org/reference/rpc/pruneblockchain.html
	requestMethodPruneBlockchain requestMethod = "pruneblockchain"

	// https://developer.unelmacoin.org/reference/rpc/sendrawtransaction.html
	requestMethodSendRawTransaction requestMethod = "sendrawtransaction"

	// https://developer.unelmacoin.org/reference/rpc/estimatesmartfee.html
	requestMethodEstimateSmartFee requestMethod = "estimatesmartfee"

	// https://developer.unelmacoin.org/reference/rpc/getrawmempool.html
...
const (
	...
	// returned in unelmacoin blocks to be milliseconds.
	timeMultiplier = 1000

	// rpc credentials are fixed in rosetta-unelmacoin
	// because we never expose access to the raw unelmacoind
...
// Client is used to fetch blocks from unelmacoind and
// to parse unelmacoin block data into Rosetta types.
//
// We opted not to use existing unelmacoin RPC libraries
...
// NewClient creates a new unelmacoin client.
func NewClient(
	baseURL string,
	genesisBlockIdentifier *types.BlockIdentifier,
	currency *types.Currency,
...
// ParseBlock returns a parsed unelmacoin block given a raw unelmacoin
...
// https://unelmacoincore.org/en/doc/0.20.0/rpc/blockchain/pruneblockchain
func (b *Client) PruneBlockchain(
	...
	// Parameters:
	//   1. Height
	// https://developer.unelmacoin.org/reference/rpc/pruneblockchain.html#argument-1-height
...
// function mirrors the behavior of a similar commit in unelmacoin-core.
//
// Source: https://github.com/unelmacoin/unelmacoin/commit/ab91bf39b7c11e9c86bb2043c24f0f377f1cf514
...
func (b *Client) parseTransactions(
	...
	logger := unelmacoinUtils.ExtractLogger(ctx, "client")
...
func (b *Client) parseTxOperations(
	...
	for networkIndex, input := range tx.Inputs {
		if unelmacoinIsCoinbaseInput(input, txIndex, networkIndex) {
...
// `unelmacoinOutput` transaction output.
func (b *Client) parseOutputTransactionOperation(
	...
	// If we are unable to parse the output account (i.e. unelmacoind
...
func (b *Client) getInputTxHash(
	...
	if unelmacoinIsCoinbaseInput(input, txIndex, inputIndex) {
		return "", -1, false
	}
...
// unelmacoinIsCoinbaseInput returns whether the specified input is
...
func unelmacoinIsCoinbaseInput(input *Input, txIndex int, inputIndex int) bool {
...
// parseOutputAccount parses a unelmacoinScriptPubKey and returns an account
...
// post makes a HTTP request to a unelmacoin node
func (b *Client) post(
	ctx context.Context,
